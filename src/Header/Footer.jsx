...
<footer
   className="relative z-10 mx-auto  max-w-screen-2xl px-4  dark:bg-dark pt-20 pb-10 lg:pt-[120px] lg:pb-20"
   >
   <div className="container mx-auto">
      <div className="flex flex-wrap -mx-4">
         <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="w-full mb-10">
           <div className="flex items-center gap-4 mb-4"> <img src="https://i.postimg.cc/s20qNBMw/logo.png" width={40} alt="" />
              <h1 className="md:text-2xl text-lg font-semibold text-black">BistroBoss</h1></div>
